...
public final class RoleServlet extends BaseServlet {
    ...
    @WebAction(actionid = ACTION_UPDATE, url = "/role/upduserole", comment = "更新角色员工用户", result = "int[]")
    ...
    @WebAction(actionid = ACTION_QUERY, url = "/role/qryuserole", comment = "查询角色员工关系列表", result = "Sheet<UserToRole>")
    ...
    @WebAction(actionid = ACTION_QUERY, url = "/role/qryoption", comment = "查询角色操作关系列表", result = "Sheet<RoleToOption>")
    ...
    @WebAction(actionid = ACTION_UPDATE, url = "/role/update", comment = "修改角色", result = "RetResult")
    @WebParam(name = "bean", type = RoleInfo.class, comment = "角色对象")
