...
public final class RoleServlet extends BaseServlet {
    ...
    @HttpMapping(actionid = ACTION_UPDATE, url = "/role/upduserole", comment = "更新角色员工用户", result = "int[]")
    @HttpParam(name = "delroleids", type = int[].class, comment = "待删除员工的角色ID")
    @HttpParam(name = "delmemberid", type = int[].class, comment = "待删除的员工ID")
    @HttpParam(name = "bean", type = UserToRole[].class, comment = "待新增的角色与员工关系对象")
    ...
    @HttpMapping(actionid = ACTION_QUERY, url = "/role/qryuserole", comment = "查询角色员工关系列表", result = "Sheet<UserToRole>")
    ...
    @HttpMapping(actionid = ACTION_UPDATE, url = "/role/updoption", comment = "更新角色的操作权限", result = "int[]")
    @HttpParam(name = "delseqids", type = int[].class, comment = "待删除的角色操作ID")
    @HttpParam(name = "bean", type = RoleToOption[].class, comment = "待新增的角色与操作关系对象")
    ...
    @HttpMapping(actionid = ACTION_QUERY, url = "/role/qryoption", comment = "查询角色操作关系列表", result = "Sheet<RoleToOption>")
    @HttpParam(name = "bean", type = RoleToOption.class, comment = "过滤条件")
    ...
    @HttpMapping(actionid = ACTION_QUERY, url = "/role/query", comment = "查询角色列表", result = "Sheet<RoleInfo>")
    @HttpParam(name = "flipper", type = Flipper.class, comment = "翻页信息")
    ...
    @HttpMapping(actionid = ACTION_CREATE, url = "/role/create", comment = "新增角色", result = "int")
    @HttpParam(name = "bean", type = RoleInfo.class, comment = "角色对象")
    ...
    @HttpMapping(actionid = ACTION_UPDATE, url = "/role/update", comment = "修改角色", result = "RetResult")
    @HttpParam(name = "bean", type = RoleInfo.class, comment = "角色对象")
