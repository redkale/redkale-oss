...
var swfobject = function () {
    var D = "undefined", r = "object", S = "Shockwave Flash", W = "ShockwaveFlash.ShockwaveFlash", q = "application/x-shockwave-flash", R = "SWFObjectExprInst", x = "onreadystatechange", O = window, j = document, t = navigator, T = false, U = [h], o = [], N = [], I = [], l, Q, E, B, J = false, a = false, n, G, m = true, M = function () {
        var aa = typeof j.getElementById != D && typeof j.getElementsByTagName != D && typeof j.createElement != D, ah = t.userAgent.toLowerCase(), Y = t.platform.toLowerCase(), ae = Y ? /win/.test(Y) : /win/.test(ah), ac = Y ? /mac/.test(Y) : /mac/.test(ah), af = /webkit/.test(ah) ? parseFloat(ah.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : false, X = !+"\v1", ag = [0, 
            0, 0], ab = null;
...
SWFUpload.prototype.addFileParam = function (a, b, c) {
    return this.callFlash("AddFileParam", [a, 
        b, 
        c])
};
SWFUpload.prototype.removeFileParam = function (a, b) {
    this.callFlash("RemoveFileParam", [a, 
        b])
};
...
SWFUpload.prototype.setButtonDimensions = function (c, a) {
    ...
    this.callFlash("SetButtonDimensions", [c, 
        a])
};
...
SWFUpload.prototype.setButtonTextPadding = function (b, a) {
    ...
    this.callFlash("SetButtonTextPadding", [b, 
        a])
};
...
SWFUpload.prototype.fileQueueError = function (a, c, b) {
    a = this.unescapeFilePostParams(a);
    this.queueEvent("file_queue_error_handler", [a, 
        c, 
        b])
};
SWFUpload.prototype.fileDialogComplete = function (b, c, a) {
    this.queueEvent("file_dialog_complete_handler", [b, 
        c, 
        a])
};
...
(function ($) {
        ...
        init: function (options, swfUploadOptions) {
            ...
            return this.each(function () {
                ...
                var settings = $.extend({
                    ...
                    swf: '/framework/uploadify/uploadify.swf', // The path to the uploadify SWF file
                    uploader: '/pipes/', // The path to the server-side upload script
                    showqueue: true, // show queue div
                    // Options
                    ...
                    buttonText: '上 传', // The text to use for the browse button
                    ...
                    removeTimeout: 99999999, // The delay in seconds before removing a queue item if removeCompleted is set to true
                ...
                if(window['MYTOKEN']) {
                    var _p = settings.uploader.indexOf("?") > 0 ? "&" : "?";
                    settings.uploader = settings.uploader + _p + "token=" + window['MYTOKEN'];
                }
                ...
                if (flashInstalled) {
                    ...
                    if (!settings.queueID) {
                        ...
                        if (settings.showqueue) $wrapper.after($queue);
    ...
    var handlers = {
        ...
        onSelect: function (file) {
            ...
            if (settings.itemTemplate == false) {
                settings.itemTemplate = '<div id="${fileID}" class="uploadify-queue-item">\
                    ...
                    <div class="cancel" onclick="javascript:$(\'#${instanceID}\').uploadify(\'cancel\', \'${fileID}\')">&nbsp;</div>\
                </div>';
            }
        ...
        onUploadStart: function (file) {
            ...
            if (false && settings.checkExisting) {
                $.ajax({
                    type: 'POST',
                    async: false,
