...
insert  into `sys_usermember`(`memberid`,`account`,`memberName`,`password`,`type`,`status`,`mobile`,`email`,`remark`,`createtime`,`updatetime`) values 
  (1000001,'admin','管理员','81dc9bdb52d04dc20036dbd8313ed055',8192,10,'','','',1704038400000,1704038400000),
  (1000002,'redkale','Redkale','81dc9bdb52d04dc20036dbd8313ed055',8192,10,'','redkale@redkale.org','',1704038400000,1704038400000);
